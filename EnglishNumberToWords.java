...
public class EnglishNumberToWords {
	private static final String[] tensNames = {
		  ...
		  private static String convertLessThan99Thousand(int number) {
			    String soFar;
		  ...
		  public static String convert(long number) {
			    ...
			    case 0:
			      ...
			      break;
			    case 1 :
			    	rsCrores = convertLessThan99Thousand(crores)
			      + " crore ";
			      break;
			    default :
			    	rsCrores = convertLessThan99Thousand(crores)
			    ...
			    case 0:
			      ...
			      break;
			    case 1 :
			    	rsLacs = convertLessThan99Thousand(lacs)
			         + " lakh ";
			      break;
			    default :
			    	rsLacs = convertLessThan99Thousand(lacs)
			    ...
			    case 1 :
			      ...
			      break;
			    default :
			    	rsHundredThousands = convertLessThan99Thousand(hundredThousands)
			         + " thousand ";
			    }
			    result =  result + rsHundredThousands;

			    String tradThousand;
			    tradThousand = convertLessThan99Thousand(thousands);
